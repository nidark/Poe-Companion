...
For different setups (other resolutions and/or scroll positions in inventory) you need to use the CheckPos function and change the coordonates in the INI config file. if you dont have one, the INI file is created automaticaly for the default resolution (1920x1080).
